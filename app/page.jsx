...
export default function Home() {
    return (
        <div className="relative w-full  px-10 pt-24 lg:p-24" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: "easeOut" }} >
            <svg
            ...
            <div className="w-full flex flex-col justify-center items-center">
                ...
                <span className="lg:w-3/4 pt-5 capitalize flex justify-center text-xl lg:text-2xl lg:leading-normal text-center">empowering business, startups and brands with the power of
                    MERN-Stack to elevate and spice up their online presence.  </span >
                <div className="py-10 flex justify-center">
                    <Link className="primary_button px-4 py-3 my-2 flex items-center gap-2 lg:cursor-none" href="/work">Explore Projects
