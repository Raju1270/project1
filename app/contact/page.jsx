            ...
            <main className="w-full  px-10 md:p-10 flex flex-col md:flex-row">
                <section className="w-full px-14">
                    ...
                    <div className="px-3 contact-info">
                        ...
                        <div className="flex justify-center items-center w-full p-16 gap-10">
                            <a className="hover:opacity-50"href="www.github.com/Raju1270"><svg viewBox="0 0 640 640">
                            ...
                            <a className="hover:opacity-50"href="linkedin.com"><svg viewBox="0 0 50 50">
                            ...
                            <a className="hover:opacity-50"href="instagram.com"><svg viewBox="0 0 24 24">
                ...
                <section className="w-full ">
                    <div className="">
                        ...
                        <form action="#" className="space-y-8 p-14">
                            <div>
                                <label for="email" className="mb-2">Your email</label>
                                <input type="email" id="email" className="contact-input w-full p-3" />
                            </div>
                            <div>
                                <label for="subject" className=" mb-2">Subject</label>
                                <input type="text" id="subject" className="contact-input p-3 w-full" required />
                            </div>
                            <div className="sm:col-span-2">
                                <label for="message" className="block mb-2">Your message</label>
                                <textarea id="message" rows="5" className="p-3 w-full contact-input" ></textarea>
                            </div>
