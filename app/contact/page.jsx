                    ...
                    <div className="px-3 contact-info">
                        <div className="">
                            <div className="flex items-center p-5 gap-5">
                                ...
                                <a className="hover:opacity-50 lg:cursor-none text-sm" href="mailto:rajuweb7@gmail.com">rajuweb7@gmail.com</a>
                            </div>
                            <div className="flex items-center p-5 gap-5">
                                ...
                                <a className="hover:opacity-50 lg:cursor-none text-sm" href="tel:+919501235412">+91 9501235412</a></div>
                        </div>
                ...
                <section className="w-full px-10  ">
                    <div className="">
                        ...
                        <form action="" onSubmit={handlesubmit} className="w-full space-y-8 p-2 flex flex-col justify-center items-center lg:p-14">
                            ...
                            <button type="submit" className=" mt-2 py-3 px-5 text-center primary_button lg:cursor-none">Send message</button>
                        </form>
                    </div>
                </section>
            </main>
