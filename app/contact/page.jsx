        ...
        <>
            <main className="w-full p-10 flex flex-col lg:flex-row">
                <section className="w-full px-14">
                    ...
                    <p className="mb-8 lg:mb-16 text-center px-3">Got a technical issue? Want to send some feedback? Need details about our plans? Let us know.</p>
                    <div className="px-3 contact-info">
                        <div className="">
                            <div className="flex items-center p-5 gap-5">
                                <svg viewBox="0 0 497 511.86">
                                ...
                                <a className="hover:opacity-50 lg:cursor-none" href="mailto:rajuweb7@gmail.com">rajuweb7@gmail.com</a>
                            </div>
                            <div className="flex items-center p-5 gap-5">
                                ...
                                <a className="hover:opacity-50 lg:cursor-none" href="tel:+919501235412">+91 9501235412</a></div>
                        </div>
                        <div className="flex justify-center items-center w-full p-16 gap-10">
                            <a className="hover:opacity-50 lg:cursor-none" target="_blank" rel="noreferrer noopener " href="https://www.github.com/Raju1270"><svg viewBox="0 0 640 640">
                            ...
                            <a className="hover:opacity-50 lg:cursor-none" target="_blank" rel="noreferrer noopener " href="https://www.linkedin.com/in/raju-maurya-15170b251"><svg viewBox="0 0 50 50">
                            ...
                            <a className="hover:opacity-50 lg:cursor-none" target="_blank" rel="noreferrer noopener " href="https://www.instagram.com/rajumaurya_13"><svg viewBox="0 0 24 24">
                ...
                <section className="w-full ">
                    <div className="">
                        ...
                        <form action="" onSubmit={handlesubmit} className="space-y-8 p-14">
                            
                            <div>
                                <label className=" mb-2">Your Name</label>
                                <input type="text" name="name" value={values.name} className="contact-input p-3 w-full lg:cursor-none" onChange={handleinput} required />
                            </div>
                            <div>
                                <label className="mb-2">Your Email</label>
                                <input type="email" name="email" value={values.email} className="contact-input w-full p-3 lg:cursor-none" onChange={handleinput} required/>
                            </div>
                            <div className="sm:col-span-2">
                                <label  className="block mb-2">Your Message</label>
                                <textarea name="message" rows="5" value={values.message} className="p-3 w-full contact-input lg:cursor-none" onChange={handleinput} required></textarea>
                            </div>
                            <button type="submit" className="py-3 px-5 text-center primary_button lg:cursor-none">Send message</button>
                        </form>
                    </div>
                </section>
            </main>
