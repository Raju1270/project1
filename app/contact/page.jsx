                    ...
                    <div className="px-3 contact-info">
                        <div className="">
                            <div className="flex items-center p-5 gap-5">
                                ...
                                <a className="hover:opacity-50" href="mailto:rajuweb7@gmail.com">rajuweb7@gmail.com</a>
                            </div>
                            <div className="flex items-center p-5 gap-5">
                                ...
                                <a className="hover:opacity-50" href="tel:+919501235412">+91 9501235412</a></div>
                        </div>
